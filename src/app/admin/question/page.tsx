...
import {batchAddQuestionsToBankUsingPost, batchDeleteQuestionsUsingPost} from "@/api/questionBankController";
  ...
  return (
    <PageContainer>
      ...
      <BatchAddQuestionsToBankModal
        ...
        onSubmit={() => setBatchAddQuestionsToBankModalVisible(false)}
